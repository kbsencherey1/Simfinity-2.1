...
public class GeminiService {
    ...
    // Country fallback insights identical to server.ts FALLBACK_INSIGHTS
    ...
    static {
        ...
        addFallback("nigeria",
            ...
            "Nestled along the outskirts of the city of Osogbo, the sacred Osun Grove is one of the last remaining primary high-canopy forests in Southern Nigeria. It is dedicated to Osun, the Yoruba goddess of fertility, and dotted with spectacular modern shrines, sculptures, and sanctuaries created by artist Susanne Wenger.",
            List.of(
        ...
        addFallback("brazil",
            ...
            "Over a stretch of 6 kilometers near Manaus, the dark, acidic Rio Negro runs alongside the pale, muddy Amazon River (Solimões) without mixing. This phenomenon is caused by differences in water temperature, speed, and sediment density, creating a stark visual border.",
            List.of(
        ...
        addFallback("morocco",
            ...
            "Perched below the peaks of the Rif Mountains, Morocco's 'Blue Pearl' Chefchaouen features streets washed entirely in shades of blue. This custom was originally introduced by Jewish refugees in the 15th century as a symbol of sky and heaven, a beautiful tradition cherished by locals to this day.",
            List.of(
        ...
        addFallback("senegal",
            ...
            "Senegal's Lake Retba (Lac Rose) famously flows with a striking pink hue caused by Dunaliella salina algae, which thrives in high-salt waters. Local salt harvesters protect their skin with Shea Butter before harvesting raw salt crystals.",
